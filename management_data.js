...
var O_TYPE      = new Set([
  // AA
  'AA01','AA03','AA04','AA07','AA08','AA17','AA20','AA21','AA23','AA24','AA26','AA27',
  // AB
  'AB02','AB03','AB06','AB14','AB15','AB19','AB21','AB23','AB24','AB26','AB30','AB34','AB35','AB37','AB38','AB46','AB47','AB54','AB56','AB59','AB60','AB62','AB64','AB65','AB67','AB74','AB75','AB76','AB78',
  // BA
  'BA02','BA04','BA05','BA10','BA12','BA13','BA17','BA25','BA28','BA30','BA33','BA35','BA36','BA39','BA43','BA45','BA52','BA55',
  // BB
  'BB02','BB13','BB14','BB15','BB21','BB22','BB23','BB29','BB30','BB31','BB32','BB33','BB34','BB37','BB41','BB43','BB44','BB45','BB46','BB47','BB49','BB51','BB52','BB53','BB55','BB56','BB57','BB58',
  // CA
  'CA01','CA09','CA14','CA16','CA17','CA18','CA19','CA21',
  // CB
  'CB03','CB14','CB20','CB21','CB22','CB25','CB28','CB31','CB33','CB36','CB37','CB38','CB40','CB42','CB43',
  // DA
  'DA01','DA03','DA04','DA08','DA13','DA19','DA26','DA37','DA38','DA39','DA46','DA48','DA49','DA51','DA52','DA54',
  // DB
  'DB04','DB06','DB07','DB10','DB12','DB19','DB20','DB22','DB25','DB28','DB31','DB32','DB33','DB34','DB35','DB36','DB37','DB43','DB45','DB46','DB48','DB49','DB50','DB57','DB58','DB59','DB60','DB61','DB62','DB64','DB69','DB70','DB72','DB74','DB80','DB81','DB82','DB83','DB86',
  // EB
  'EB08','EB09',
  // FA
  'FA03','FA06','FA07','FA08','FA12','FA13','FA14','FA15','FA17','FA18','FA20','FA21','FA25','FA26','FA27',
  // FB (FB08 추가)
  'FB03','FB08','FB09','FB11','FB14','FB16','FB17','FB18','FB19','FB22','FB23','FB26','FB28','FB31','FB32','FB33','FB35','FB37','FB40','FB41','FB42','FB49','FB51','FB52','FB53','FB54','FB57','FB59','FB63','FB66','FB67',
  // GA (GA04, GA13 제거)
  'GA01','GA02','GA03','GA11','GA12','GA18','GA19','GA20','GA21','GA23','GA24','GA29','GA31','GA32','GA33','GA34','GA38','GA39','GA40','GA41','GA44',
  // GB (GB18, GB44, GB58, GB59, GB68, GB70 제거)
  'GB01','GB03','GB08','GB09','GB10','GB11','GB12','GB13','GB15','GB16','GB17','GB20','GB21','GB22','GB23','GB26','GB27','GB29','GB30','GB37','GB38','GB40','GB43','GB45','GB46','GB47','GB48','GB49','GB50','GB51','GB53','GB54','GB55','GB57','GB62','GB65','GB66','GB67','GB69','GB74','GB75','GB76',
  // HA
  'HA02','HA05','HA06','HA11','HA14',
  // HB (HB06 추가)
  'HB06','HB07','HB09','HB10','HB12',
  // IB
  'IB02',
  // JA
  ...
  // MA (MA07 추가)
  'MA01','MA02','MA05','MA06','MA07','MA08','MA09',
  // MB (MB19 제거)
  'MB01','MB02','MB05','MB06','MB08','MB09','MB10','MB11','MB12','MB13','MB14','MB15','MB16','MB17','MB18',
  // NB
  'NB04',
  // OA
  'OA01','OA03',
  ...
  // QA
  'QA05','QA07','QA08','QA11','QA12','QA13','QA14','QA15','QA16','QA17',
  'QA19','QA20','QA21','QA25','QA27','QA29','QA31',
  'QA41','QA43','QA44','QA45','QA47','QA50','QA51',
  'QA58','QA62','QA64','QA69','QA70','QA72','QA73','QA75','QA78',
  'QA81','QA84','QA86','QA88','QA89','QA90','QA94','QA104','QA105','QA108',
  // QB (신규 추가)
  'QB03','QB05','QB09','QB10','QB11','QB12','QB13','QB14','QB15','QB16','QB17',
  'QB19','QB20','QB21','QB23','QB24','QB25','QB26','QB27','QB28','QB30','QB32','QB33',
  'QB35','QB36','QB38','QB44','QB47','QB48','QB49','QB50','QB51','QB52','QB53','QB54',
  'QB56','QB58','QB60','QB69','QB70','QB72','QB73','QB75','QB76','QB77','QB78','QB79',
  'QB81','QB82','QB83','QB84','QB85','QB86','QB91','QB93','QB94','QB96','QB97',
  'QB99','QB100','QB102','QB103','QB104','QB105','QB106','QB108',
  // RA
  'RA01','RA02','RA03',
  // RB
  'RB02','RB03','RB04','RB05',
  // SA (신규 추가)
  'SA01','SA04','SA05','SA08','SA09','SA10','SA11','SA16','SA17','SA18',
  'SA21','SA23','SA24','SA25','SA27','SA28','SA29','SA30',
  // SB
  'SB02','SB03','SB04','SB05','SB06','SB07','SB10','SB11','SB12','SB14','SB17','SB18','SB19','SB21',
  // TA (신규 추가)
  'TA04','TA05','TA09','TA11','TA15','TA16','TA17','TA18','TA19','TA20','TA21',
  'TA23','TA27','TA31','TA32','TA34','TA35','TA36','TA38','TA39','TA43','TA44','TA45',
  // TB
  'TB07','TB10','TB13','TB14','TB15','TB16','TB17','TB18','TB19','TB20','TB21','TB22','TB25','TB26','TB27','TB28','TB29','TB35',
  // UA (신규 추가)
  'UA06','UA07','UA11','UA13','UA15','UA26','UA27','UA31','UA32','UA33',
  'UA39','UA40','UA42','UA43','UA45','UA49','UA50','UA51',
  'UA54','UA55','UA56','UA57','UA58','UA60','UA61','UA63','UA65','UA66','UA67',
  // UB (신규 추가)
  'UB01','UB03','UB04','UB05','UB06','UB08','UB10','UB11','UB16',
  'UB19','UB20','UB21','UB27','UB28','UB31','UB36','UB37',
  'UB39','UB40','UB41','UB42','UB43','UB44','UB49','UB51','UB52','UB53','UB54',
  'UB60','UB61','UB62','UB63','UB64','UB66','UB68','UB71','UB72','UB73',
  // VA
  'VA05',
  // VB
  'VB02','VB06','VB09','VB11','VB14','VB15','VB16','VB17','VB18','VB19','VB21','VB23','VB25','VB26','VB27',
  // WA (신규 추가)
  'WA03','WA04','WA05','WA06','WA15','WA18','WA19','WA22','WA23','WA25','WA26','WA29','WA33','WA36',
  'WA40','WA41','WA42','WA43','WA44','WA46','WA47','WA48','WA50','WA51',
  'WA53','WA54','WA55','WA56','WA58','WA62','WA63','WA64','WA65','WA66','WA67',
  'WA72','WA76','WA77','WA78','WA90',
  // WB (신규 추가)
  'WB01','WB04','WB05','WB06','WB07','WB11','WB12','WB13','WB15','WB16','WB17','WB18','WB20','WB22',
  'WB24','WB25','WB28','WB29','WB30','WB31','WB32','WB33','WB34','WB35','WB36','WB37','WB38','WB39','WB40',
  'WB44','WB45','WB46','WB47','WB48','WB49','WB50','WB51','WB53','WB54','WB55','WB56','WB57','WB58',
  'WB60','WB61','WB63','WB64','WB65','WB72','WB73','WB75',
  'WB79','WB80','WB81','WB82','WB83','WB85','WB86','WB87','WB89','WB90',
  'WB92','WB93','WB94','WB96','WB97','WB98','WB99',
  'WB100','WB101','WB102','WB103','WB104','WB106','WB107','WB108','WB109','WB111','WB113','WB115',
  // XA (신규 추가)
  'XA05','XA09','XA10','XA11','XA14','XA15','XA17','XA19','XA20','XA21','XA22',
  'XA25','XA27','XA28','XA30','XA31','XA32','XA33','XA36','XA37','XA38','XA41','XA45',
  // YA
  'YA01','YA03','YA09','YA10',
  // YB
...
var Q3_TYPE     = new Set(['FA15','FB11','QA78','SA16','UA13','UA43','YA01']); // 순서/선택 나열형: stem에 ㄱ.ㄴ.ㄷ. 있지만 opts(①②③④)가 정오 판단 대상
